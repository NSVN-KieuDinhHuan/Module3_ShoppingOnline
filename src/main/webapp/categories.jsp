                            ...
                            <ul class="top_nav_menu">
                                ...
                                <li class="account">
                                    ...
                                    <ul class="account_selection">
                                        <c:if test="${usename!=null}">
                                            <li><a href="/home?action=logout"><i class="fa fa-sign-out"
                                                                                 aria-hidden="true"></i>Logout</a></li>
                                        </c:if>
                                        <c:if test="${usename==null}">
                                            <li><a href="/signin.jsp"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign
                                                In</a></li>
                                            <li><a href="/register.jsp"><i class="fa fa-user-plus"
                                        ...
                                        <div class="product-item">
                                            <div class="product product_filter">
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_name"><a href="/single.jsp">${product.name}</a>
                                                    </h6>
