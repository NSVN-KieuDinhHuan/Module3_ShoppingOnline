		...
		<div class="row">
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="${product.productImage}" alt="" data-image="${product.productImage}"></li>
									<li class="active"><img src="${product.productImage}" alt="" data-image="${product.productImage}"></li>
									<li><img src="${product.productImage}" alt="" data-image="${product.productImage}"></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(${product.productImage})"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="original_price">$ ${Math.round(1.1*product.price)}</div>
