                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/products">Back To Product List</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Are you sure? Please check below before you delete</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputProjectLeader" class="form-control" name="image" value="${product.productImage}">
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
