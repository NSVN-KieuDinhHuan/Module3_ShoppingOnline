    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <p>Delete Category(ies)</p>
                <form action="/categories?action=delete&id=${requestScope['category'].id}" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="id"
                               placeholder="${requestScope['category'].id}">
                    </div>
                    ....
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Category_Name</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="name"
                               placeholder="${requestScope['category'].name}" disabled>
                    </div>
