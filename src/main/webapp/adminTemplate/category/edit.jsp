    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/products?action=showHome" class="nav-link">Home</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <p>Edit Category(ies)</p>
                <form action="/categories?action=edit&id=${category.id}" method="post">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Set ID</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="id" value="${category.id}">
                    </div>....
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Set Category_Name</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="name" value="${category.name}">
                    </div>
                    <button type="submit" class="btn btn-primary">Accept this Edit</button>
                </form>
                </tbody>
                </table>
                </form>
